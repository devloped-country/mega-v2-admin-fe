  ...
  return (
    <>
      <header className={styles.header}>
        <ModalButton type="canceled" text="나가기" onAction={handleClickCanceledButton} />
      </header>
      <div className={styles.hero}></div>
      <section className={styles.content}>
        <div className={styles.infoHeader}>
          <img className={styles.profile} src={`${import.meta.env.VITE_CLOUD_FRONT_ID}/Frame 417.svg`} />
        ...
        <div className={styles.menuWrapper}>
          <ul className={styles.menuList}>
            <li className={`${styles.menuItem} ${isViewStatus === "info" && styles.active}`} onClick={() => setIsViewStatus("info")}>
              정보
            </li>
            <li className={`${styles.menuItem} ${isViewStatus === "attendance" && styles.active}`} onClick={() => setIsViewStatus("attendance")}>
              출결
            </li>
            <li className={`${styles.menuItem} ${isViewStatus === "schedule" && styles.active}`} onClick={() => setIsViewStatus("schedule")}>
              일정
            </li>
          </ul>
