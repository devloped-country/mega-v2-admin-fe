...
function Notice() {
  ...
  const [managerId, setManagerId] = useState(data && Object.entries(data.data.managerInfo)[0]);
  ...
  return (
    <section className={styles.wrapper}>
      <ContentHeader
        ...
        img={`${import.meta.env.VITE_CLOUD_FRONT_ID}/free-icon-font-megaphone-3914404 1.svg`}
